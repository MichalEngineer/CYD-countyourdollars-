...
@module15_managed_to_java = internal constant [239 x %struct.TypeMapModuleEntry] [
	; 0
	%struct.TypeMapModuleEntry {
...
@__TypeMapModule_assembly_name.7 = internal constant [4 x i8] c"CYD\00", align 1
...
@map_modules = global [16 x %struct.TypeMapModule] [
	...
	; 7
	%struct.TypeMapModule {
		[16 x i8] c"r\E99/h\83\04N\98\84\B0\B3\E1d\93\E3", ; module_uuid: 2f39e972-8368-4e04-9884-b0b3e16493e3
		i32 2, ; entry_count
		i32 0, ; duplicate_count
		...
		%struct.TypeMapModuleEntry* null, ; duplicate_map
		i8* getelementptr inbounds ([4 x i8], [4 x i8]* @__TypeMapModule_assembly_name.7, i32 0, i32 0), ; assembly_name: CYD
		%struct.MonoImage* null, ; image
		i32 0, ; java_name_width
		i8* null; java_map
	}, 
	...
	; 15
	%struct.TypeMapModule {
		[16 x i8] c"\F1\B9\E7\FF\05p\D3I\AB\22\E0\B5H\A7\01\92", ; module_uuid: ffe7b9f1-7005-49d3-ab22-e0b548a70192
		i32 239, ; entry_count
		i32 122, ; duplicate_count
		%struct.TypeMapModuleEntry* getelementptr inbounds ([239 x %struct.TypeMapModuleEntry], [239 x %struct.TypeMapModuleEntry]* @module15_managed_to_java, i32 0, i32 0), ; map
...
@__java_type_names.51 = internal constant [36 x i8] c"crc64fe55af13ec278c5b/LoginActivity\00", align 1
@__java_type_names.52 = internal constant [35 x i8] c"crc64fe55af13ec278c5b/MainActivity\00", align 1
...
@__java_type_names.62 = internal constant [57 x i8] c"androidx/appcompat/graphics/drawable/DrawerArrowDrawable\00", align 1
@__java_type_names.63 = internal constant [33 x i8] c"androidx/appcompat/app/ActionBar\00", align 1
@__java_type_names.64 = internal constant [46 x i8] c"androidx/appcompat/app/ActionBar$LayoutParams\00", align 1
@__java_type_names.65 = internal constant [58 x i8] c"androidx/appcompat/app/ActionBar$OnMenuVisibilityListener\00", align 1
@__java_type_names.66 = internal constant [74 x i8] c"mono/androidx/appcompat/app/ActionBar_OnMenuVisibilityListenerImplementor\00", align 1
@__java_type_names.67 = internal constant [54 x i8] c"androidx/appcompat/app/ActionBar$OnNavigationListener\00", align 1
@__java_type_names.68 = internal constant [37 x i8] c"androidx/appcompat/app/ActionBar$Tab\00", align 1
@__java_type_names.69 = internal constant [45 x i8] c"androidx/appcompat/app/ActionBar$TabListener\00", align 1
@__java_type_names.70 = internal constant [45 x i8] c"androidx/appcompat/app/ActionBarDrawerToggle\00", align 1
@__java_type_names.71 = internal constant [54 x i8] c"androidx/appcompat/app/ActionBarDrawerToggle$Delegate\00", align 1
@__java_type_names.72 = internal constant [62 x i8] c"androidx/appcompat/app/ActionBarDrawerToggle$DelegateProvider\00", align 1
@__java_type_names.73 = internal constant [41 x i8] c"androidx/appcompat/app/AppCompatActivity\00", align 1
@__java_type_names.74 = internal constant [41 x i8] c"androidx/appcompat/app/AppCompatDelegate\00", align 1
@__java_type_names.75 = internal constant [41 x i8] c"androidx/appcompat/app/AppCompatCallback\00", align 1
@__java_type_names.76 = internal constant [34 x i8] c"androidx/appcompat/widget/Toolbar\00", align 1
@__java_type_names.77 = internal constant [67 x i8] c"androidx/appcompat/widget/Toolbar_NavigationOnClickEventDispatcher\00", align 1
@__java_type_names.78 = internal constant [58 x i8] c"androidx/appcompat/widget/Toolbar$OnMenuItemClickListener\00", align 1
@__java_type_names.79 = internal constant [74 x i8] c"mono/androidx/appcompat/widget/Toolbar_OnMenuItemClickListenerImplementor\00", align 1
@__java_type_names.80 = internal constant [39 x i8] c"androidx/appcompat/widget/DecorToolbar\00", align 1
@__java_type_names.81 = internal constant [52 x i8] c"androidx/appcompat/widget/ScrollingTabContainerView\00", align 1
@__java_type_names.82 = internal constant [75 x i8] c"androidx/appcompat/widget/ScrollingTabContainerView$VisibilityAnimListener\00", align 1
@__java_type_names.83 = internal constant [35 x i8] c"androidx/appcompat/view/ActionMode\00", align 1
@__java_type_names.84 = internal constant [44 x i8] c"androidx/appcompat/view/ActionMode$Callback\00", align 1
@__java_type_names.85 = internal constant [41 x i8] c"androidx/appcompat/view/menu/MenuBuilder\00", align 1
@__java_type_names.86 = internal constant [50 x i8] c"androidx/appcompat/view/menu/MenuBuilder$Callback\00", align 1
@__java_type_names.87 = internal constant [52 x i8] c"androidx/appcompat/view/menu/MenuPresenter$Callback\00", align 1
@__java_type_names.88 = internal constant [43 x i8] c"androidx/appcompat/view/menu/MenuPresenter\00", align 1
@__java_type_names.89 = internal constant [38 x i8] c"androidx/appcompat/view/menu/MenuView\00", align 1
@__java_type_names.90 = internal constant [42 x i8] c"androidx/appcompat/view/menu/MenuItemImpl\00", align 1
@__java_type_names.91 = internal constant [44 x i8] c"androidx/appcompat/view/menu/SubMenuBuilder\00", align 1
@__java_type_names.92 = internal constant [51 x i8] c"com/google/common/util/concurrent/ListenableFuture\00", align 1
@__java_type_names.93 = internal constant [54 x i8] c"androidx/lifecycle/HasDefaultViewModelProviderFactory\00", align 1
@__java_type_names.94 = internal constant [39 x i8] c"androidx/lifecycle/ViewModelStoreOwner\00", align 1
@__java_type_names.95 = internal constant [37 x i8] c"androidx/lifecycle/ViewModelProvider\00", align 1
@__java_type_names.96 = internal constant [45 x i8] c"androidx/lifecycle/ViewModelProvider$Factory\00", align 1
@__java_type_names.97 = internal constant [34 x i8] c"androidx/lifecycle/ViewModelStore\00", align 1
@__java_type_names.98 = internal constant [47 x i8] c"xamarin/android/net/OldAndroidSSLSocketFactory\00", align 1
@__java_type_names.99 = internal constant [32 x i8] c"javax/security/cert/Certificate\00", align 1
@__java_type_names.100 = internal constant [36 x i8] c"javax/security/cert/X509Certificate\00", align 1
@__java_type_names.101 = internal constant [28 x i8] c"javax/security/auth/Subject\00", align 1
@__java_type_names.102 = internal constant [24 x i8] c"javax/net/SocketFactory\00", align 1
@__java_type_names.103 = internal constant [33 x i8] c"javax/net/ssl/HttpsURLConnection\00", align 1
@__java_type_names.104 = internal constant [31 x i8] c"javax/net/ssl/HostnameVerifier\00", align 1
@__java_type_names.105 = internal constant [25 x i8] c"javax/net/ssl/KeyManager\00", align 1
@__java_type_names.106 = internal constant [25 x i8] c"javax/net/ssl/SSLSession\00", align 1
@__java_type_names.107 = internal constant [32 x i8] c"javax/net/ssl/SSLSessionContext\00", align 1
@__java_type_names.108 = internal constant [27 x i8] c"javax/net/ssl/TrustManager\00", align 1
@__java_type_names.109 = internal constant [31 x i8] c"javax/net/ssl/X509TrustManager\00", align 1
@__java_type_names.110 = internal constant [32 x i8] c"javax/net/ssl/KeyManagerFactory\00", align 1
@__java_type_names.111 = internal constant [25 x i8] c"javax/net/ssl/SSLContext\00", align 1
@__java_type_names.112 = internal constant [31 x i8] c"javax/net/ssl/SSLSocketFactory\00", align 1
@__java_type_names.113 = internal constant [34 x i8] c"javax/net/ssl/TrustManagerFactory\00", align 1
@__java_type_names.114 = internal constant [37 x i8] c"android/window/OnBackInvokedCallback\00", align 1
@__java_type_names.115 = internal constant [39 x i8] c"android/window/OnBackInvokedDispatcher\00", align 1
@__java_type_names.116 = internal constant [27 x i8] c"android/widget/AdapterView\00", align 1
@__java_type_names.117 = internal constant [50 x i8] c"android/widget/AdapterView$OnItemSelectedListener\00", align 1
@__java_type_names.118 = internal constant [22 x i8] c"android/widget/Button\00", align 1
...
@java_type_names = local_unnamed_addr constant [337 x i8*] [
	...
	i8* getelementptr inbounds ([74 x i8], [74 x i8]* @__java_type_names.66, i32 0, i32 0),
	...
	i8* getelementptr inbounds ([67 x i8], [67 x i8]* @__java_type_names.77, i32 0, i32 0),
